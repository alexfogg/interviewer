...
i1 = Interview.create(name: 'Basic Ruby', cost: 5.00)
i2 = Interview.create(name: 'Advanced Ruby', cost: 10.00)
i3 = Interview.create(name: 'Basic JS', cost: 5.00)
i4 = Interview.create(name: 'Advanced JS', cost: 10.00)
...
p1 = Progress.create(num_right: 0, num_wrong: 0, percentage: 0.00)
p2 = Progress.create(num_right: 0, num_wrong: 0, percentage: 0.00)
p3 = Progress.create(num_right: 0, num_wrong: 0, percentage: 0.00)
p4 = Progress.create(num_right: 0, num_wrong: 0, percentage: 0.00)
