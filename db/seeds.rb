...
p1 = Progress.create(num_right: 25, num_wrong: 67, percentage: 0.00)
p2 = Progress.create(num_right: 7, num_wrong: 34, percentage: 0.00)
p3 = Progress.create(num_right: 18, num_wrong: 93, percentage: 0.00)
p4 = Progress.create(num_right: 56, num_wrong: 15, percentage: 0.00)
